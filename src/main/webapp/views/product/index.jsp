                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <a class="btn btn-success" style="margin-left: 10px; float: right; width: 80px;"
                               href="${pageContext.request.contextPath}/product/create">Create</a>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-success"
                                               ...
                                               href="${pageContext.request.contextPath}/product/edit?id=${row.id}">Edit</a>
                                            <a class="btn btn-warning"
                                               style="margin-left: 40px; width: 80px;"
                                               href="${pageContext.request.contextPath}/product/detail?id=${row.id}">View</a>
