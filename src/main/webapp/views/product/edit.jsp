...
<div id="right-panel" class="right-panel">
    ...
    <!-- Header-->
    <form:form method="post" action="${pageContext.request.contextPath}/product/edit" modelAttribute="product" enctype="multipart/form-data">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <div class="form-group">
                                    <form:label class=" form-control-label" path="id"></form:label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <img width="300px" height="300px" src="${pageContext.request.contextPath}/img/${product.thumbnailUrl}" alt=""/>
                                    </div>
                                </div>
                            </div>
